-- Premium plan genişletmesi: haftalık AI değerlendirme ve AI beslenme
-- önerisi de artık ücretsiz/ücretli günlük sayaçlarına tabi (bkz.
-- lib/usage-limits.ts). Limit dolduğunda bu iki özellik hata döndürmez,
-- sessizce yerel/yedek yanıta düşer (ilgili route'lara bakınız).
...
alter table public.usage_counters
  ...
  check (feature in ('chat', 'photo', 'text_nutrition', 'weekly_review', 'nutrition_advice'));
