...
test("uses repetitions or duration for bodyweight progression", () => {
  const repetitionSuggestion = progressionSuggestion({ exerciseLogId: "two", exerciseName: "Şınav", completedAt: "2026-07-20T10:00:00Z", isBodyweight: true, sets: [{ setNumber: 1, weightKg: null, reps: 12, durationSeconds: null, rpe: 6, note: null }] });
  const durationSuggestion = progressionSuggestion({ exerciseLogId: "three", exerciseName: "Plank", completedAt: "2026-07-20T10:00:00Z", isBodyweight: true, sets: [{ setNumber: 1, weightKg: null, reps: null, durationSeconds: 30, rpe: 7, note: null }] });
...
test("does not increase load after a very hard performance", () => {
  const suggestion = progressionSuggestion({ exerciseLogId: "four", exerciseName: "Leg Press", completedAt: "2026-07-20T10:00:00Z", isBodyweight: false, sets: [{ setNumber: 1, weightKg: 80, reps: 8, durationSeconds: null, rpe: 9, note: null }] });
